...
class CPU(
    ...
    private fun decodeAndExecute(opcode: Int) = when (opcode) {
        ...
        LDA_ABS -> ldaAbsolute()
        LDA_ABX -> ldaAbsoluteX()
        LDA_ABY -> ldaAbsoluteY()
        LDA_INX -> ldaIndirectX()
        LDA_INY -> ldaIndirectY()
        // LDX
        LDX_IMM -> ldxImmediate()
        LDX_ABS -> ldxAbsolute()
        LDX_ABY -> ldxAbsoluteY()
        // LDY
        LDY_IMM -> ldyImmediate()
        LDY_ABS -> ldyAbsolute()
        // STA
        STA_ZP  -> staZeroPage()
        STA_ZPX -> staZeroPageX()
        STA_ABS -> staAbsolute()
        STA_ABX -> staAbsoluteX()
        STA_ABY -> staAbsoluteY()
        STA_INX -> staIndirectX()
        STA_INY -> staIndirectY()
        // STX
        STX_ZP  -> stxZeroPage()
        ...
        AND_ABS -> andAbsolute()
        AND_ABX -> andAbsoluteX()
        AND_ABY -> andAbsoluteY()
        AND_INX -> andIndirectX()
        AND_INY -> andIndirectY()
        // ORA
        ORA_IMM -> oraImmediate()
        ORA_ZP  -> oraZeroPage()
        ORA_ZPX -> oraZeroPageX()
        ORA_ABS -> oraAbsolute()
        ORA_ABX -> oraAbsoluteX()
        ORA_ABY -> oraAbsoluteY()
        ORA_INX -> oraIndirectX()
        ORA_INY -> oraIndirectY()
        // BIT
        BIT_ZP  -> bitZeroPage()
        BIT_ABS -> bitAbsolute()
        // Shift
        LSR_ACC -> lsrAccumulator()
        // Compare
        CMP_IMM -> cmpImmediate()
        CPX_IMM -> cpxImmediate()
        CPY_IMM -> cpyImmediate()
        // Branch
        BPL -> bpl()
        BMI -> bmi()
        BVC -> bvc()
        ...
        // INC/DEC
        INC_ZP  -> incZeroPage()
        INC_ZPX -> incZeroPageX()
        INC_ABS -> incAbsolute()
        INC_ABX -> incAbsoluteX()
        INX -> inx()
        INY -> iny()
        DEX -> dex()
        DEY -> dey()
